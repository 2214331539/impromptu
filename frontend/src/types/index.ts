...
export type SessionPhase = "drawing" | "mic_check" | "preparing" | "speaking" | "review" | "submitted";
...
export interface Task {
  ...
  preparation_seconds: number; speaking_seconds: number; starts_at: string; due_at: string;
